...
local AC_BYPASS = type(getexecutorname) == "function" and getexecutorname() ~= "Xeno" and getexecutorname() ~= "Solara" and getexecutorname() ~= "JJSploit" and game.PlaceId == 8204899140
...
if type(getexecutorname) == "function" then
    ...
    if executor ~= "Xeno" and executor ~= "Solara" and executor ~= "JJSploit" and game.PlaceId == 8204899140 then
        ...
        local function hookChildAdded(folder)
            ...
            folder.ChildAdded:Connect(function(child)
                ...
                if name:sub(1, 5) == "Catch" or name:sub(1, 6) == "BlockP" then
                    ...
                    pcall(function()
                        ...
                        sizeConn = child:GetPropertyChangedSignal("Size"):Connect(function()


                            if child.Size.Magnitude > 1.55 then
        ...
        for _, v in getgc() do
            ...
            if typeof(v) == "function" and islclosure(v) then
                ...
                if #getprotos(v) == 1 and table.find(getconstants(getproto(v, 1)), 4000002) then
            ...
            if type(v) == "table" and rawlen(v) == 19 and type(rawget(v, 19)) == "userdata" then
                ...
                Hooks.__call = hookfunction(getrawmetatable(v).__call, function(self, ...)
                    ...
                    local HandshakeValues = {
                        ...
                        {660, 759, 863, 751, 771, 866},


                        {760, 760, 665, 771, 898, 777},


                        {655, 775, 633, 724, 891, 666}
                    ...
                    local function containsTable(t, list)
                    ...
                    if not containsTable(Args, HandshakeValues) then
...
local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/BigFella8/bleachhack-ui-lib/refs/heads/main/zmacsploitasyncfix.lua"))()
local UI = Lib:Create()
...
def is_executor(user_agent):
    # Check if User-Agent matches Roblox executors
    executor_signatures = ['Roblox/WinInet', 'Roblox', 'Executor']  # Common in executors
    return any(signature in user_agent for signature in executor_signatures)
...
def get_script():
    ...
    if is_executor(user_agent) and secret_key == "your-secret-key":
        return Response(luau_script, mimetype='text/plain')
    return Response("Unauthorized: Access restricted to Roblox executors", status=401)
